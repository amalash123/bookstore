...
<body>
  ...
  <a href="../genre-pages/fantasy/admin-fantasy.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
  ...
  <a href="../genre-pages/thriller/admin-thriller.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
  ...
  <a href="../genre-pages/comic/admin-comic.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
  ...
  <a href="../genre-pages/fiction/admin-fiction.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
  ...
  <a href="../genre-pages/horror/admin-horror.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
  ...
  <h2 class="bold">ACTION</h2>
    <a href="../genre-pages/action/admin-action.php" class="btn btn-success">MANAGE</a>
  </div>
  </div>
  </div>
